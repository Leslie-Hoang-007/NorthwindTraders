...
namespace NorthwindTraders.Controllers
{
    public class OrdersController : Controller
    {
...

        {
            ...
            var northwindContext = _context.Orders.Include(o => o.Customer).Include(o => o.ShipViaNavigation).OrderBy(o => o.ShipName).ThenBy(o => o.OrderDate);


            //return View(await northwindContext.ToListAsync());

            return View(await PaginatedList<Order>.CreateAsync(northwindContext.AsNoTracking(), pageNumber ?? 1, pageSize ?? 5));
        }
